    ...
    <>
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-gradient-to-r from-blue-500 to-blue-600 min-h-[80vh] md:w-[35%]">
        ...
        <div className="flex justify-center items-center">
          <button onClick={saveToDB} disabled={todos.length === 0} className="bg-white mx-2 rounded-full hover:bg-white disabled:bg-gray-400 p-4 py-2 text-sm font-bold text-black">
            Save to DB
          </button>
        </div>
      </div>
